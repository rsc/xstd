...
import (
	...
	"rsc.io/xstd/go1/io"
	"rsc.io/xstd/go1/io/ioutil"
	"rsc.io/xstd/go1/text/template"
	"rsc.io/xstd/go1/text/template/parse"
)
...
// as template.FuncMap, copied here so clients need not import "rsc.io/xstd/go1/text/template".
